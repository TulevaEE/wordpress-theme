        ...
        <div class="col-sm-4">
            <div class="security-block">
                ...
                <div class="security-block__content">
                    <h4><?php _e('Financial Inspection', TEXT_DOMAIN) ?></h4>
                    <p><?php _e('issued a licence to Tuleva fund manager and controls that our everyday operations comply with regulations.', TEXT_DOMAIN) ?></p>
                </div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="security-block">
                ...
                <div class="security-block__content">
                    <h4><?php _e('Swedbank', TEXT_DOMAIN) ?></h4>
                    <p><?php _e('is Tuleva pension funds’ depositary bank. Depositary bank approves every transaction with fund’s assets. Exactly like with bank’s own funds.', TEXT_DOMAIN) ?></p>
                </div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="security-block">
                ...
                <div class="security-block__content">
                    <h4><?php _e('State guarantee fund', TEXT_DOMAIN) ?></h4>
                    <p><?php _e('protects all pension fund investors against the worst in case fund manager causes harm to investors.', TEXT_DOMAIN) ?></p>
                </div>
            </div>
        </div>
    </div>
