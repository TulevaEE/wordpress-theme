...
$content_class = $image_url ? 'col-lg-7 col-xl-6' : 'col-lg-12';
...
?>
<section class="section-media d-flex flex-column section-spacing <?php echo $bg_class; ?>">
    <div class="container my-auto">
        <div class="row align-items-start align-items-xl-center gy-5 gx-lg-5">
            <?php if ($image_url) { ?>
                <div class="section-media-slot col-lg-5 col-xl-6 <?php echo $left_image_visibility_class; ?>">
            ...
            <?php if ($image_url && $image_alignment === 'right'): ?>
                <div class="section-media-slot col-lg-5 col-xl-6 <?php echo $right_image_visibility_class; ?>">
                    <?php get_template_part('templates/components/media-block/media-block-image'); ?>
                </div>
            <?php endif; ?>
        </div>
