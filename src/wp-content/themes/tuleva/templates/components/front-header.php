        ...
        <div class="container my-auto">
            <div class="row align-items-center py-5">
                <div class="col-lg-6 text-center text-lg-left pr-lg-5 pr-lg-6">
                    ...
                    <?php _e('<a href="https://pension.tuleva.ee/account" class="btn btn-primary btn-lg mb-3 d-none d-md-block ga" data-label="see-account-balance">See you pension account balance</a>', TEXT_DOMAIN); ?>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 d-none d-md-flex align-items-center">
                        <span class="membercount mr-4">5646</span>
