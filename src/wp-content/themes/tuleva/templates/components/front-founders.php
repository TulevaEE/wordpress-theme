<div class="container">
    <div class="front-founders">
        <div class="row">
            <div class="neivelt-image col-md-6"></div>
            <div class="col-md-6 founder-text-col">
                <div class="row"></div>
        ...
        <div class="row">
            ...
            <div class="annika-image col-md-6"></div>
        </div>

        <div class="row">
            <div class="taavetkristo-image col-md-6"></div>
            <div class="col-md-6">
                <div class="row"></div>
                <div class="founders-name-badge">
                    <div class="founders-name">
