    ...
    <div class="card-body p-4 second-pillar-payment-rate-calculator">
        ...
        <div class="card bg-blue-washed p-3">
            ...
            <div class="form-group row mb-0">
                <label for="returnRate" class="col-sm-6 col-form-label pr-0 pb-3 pb-sm-2 vertical-align">
            ...
            <div class="d-flex align-items-center justify-content-between mb-2 px-sm-3">
                <div class="mr-1">
                    <strong class="d-block">
                        ...
                        <span class="text-nowrap text-success font-weight-normal income-tax-savings small"><span
