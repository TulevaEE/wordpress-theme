                ...
                <div class="row">
                    ...
                    <div class="col-md-6 ps-md-6">
                        ...
                        <ul class="list-style-arrow text-secondary">
                            ...
                            <li>
                                <a href="<?php echo get_site_url(); ?>/wp-content/uploads/2025/12/Pohiteave-TUK00-kehtib-alates-01.12.2025.pdf" target="_blank"><?php _e('Key Investor Information', TEXT_DOMAIN) ?></a><?php _e(' (in Estonian)', TEXT_DOMAIN) ?>
                            </li>
                            <li>
                        ...
                        <ul class="list-style-arrow text-secondary">
                            <li>
                                <?php echo generate_report_link('https://tuleva.ee/wp-content/uploads/2026/01/Tuleva-Maailma-Volakirjade-Pensionifondi-investeeringute-aruanne-detsember-2025.pdf',__('Investment reports', TEXT_DOMAIN)); ?><?php _e(' (in Estonian)', TEXT_DOMAIN) ?>
                                <br>
