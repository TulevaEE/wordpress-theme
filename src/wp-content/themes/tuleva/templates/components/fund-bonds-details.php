                    ...
                    <div class="col-md-5 offset-md-1">
                        ...
                        <ul class="list-style-arrow">
                            <li>
                                ...
                                <br>
                                <a href="<?php echo get_site_url(); ?>/wp-content/uploads/2023/04/TULVPF-investeeringute-aruanne-310323.pdf" target="_blank">03.23</a>
                                <br>
                        ...
                        <div class="fund-info__item">
                            ...
                            <?php echo sprintf(__('%s tons / $1M turnover per year', TEXT_DOMAIN), 159) ?>
                        </div>
                        <div class="fund-info__item">
                            ...
                            <?php echo sprintf(
                                ...
                                '0.30', // Tobacco
                                '0.82', // UN Global Compact Violators
                                '0.05', // Thermal Coal
                                '0.00'  // Oil Sands
                            ); ?>
                        </div>
