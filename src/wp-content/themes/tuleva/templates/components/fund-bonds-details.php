                    ...
                    <div class="col-md-5 offset-md-1">
                        ...
                        <ul class="list-style-arrow">
                            <li>
                                ...
                                <br>
                                <?php echo generate_report_link('https://tuleva.ee/wp-content/uploads/2024/07/TULVPF-investeeringute-aruanne-300624.pdf'); ?>
                                <br>
                        ...
                        <div class="fund-info__item">
                            ...
                            <?php echo sprintf(__('%s tons / $1M turnover per year', TEXT_DOMAIN), 152.06) ?>
                        </div>
                        <div class="fund-info__item">
