                ...
                <div class="row">
                    ...
                    <div class="col-md-5 offset-md-1">
                        ...
                        <ul class="list-style-arrow mb-5">
                            ...
                            <li>
                                <a href="<?php echo get_site_url(); ?>/wp-content/uploads/2024/11/Pohiteave-TUK00-14.11.2024.pdf" target="_blank"><?php _e('Key Investor Information (in Estonian)', TEXT_DOMAIN) ?></a>
                            </li>
                            <li>
                        ...
                        <ul class="list-style-arrow">
                            <li>
                                ...
                                <br>
                                <?php echo generate_report_link('https://tuleva.ee/wp-content/uploads/2024/12/TULVPF-investeeringute-aruanne-291124.pdf'); ?>
                                <br>
                        ...
                        <div class="fund-info__item">
                            ...
                            <?php echo sprintf(__('%s tons / $1M turnover per year', TEXT_DOMAIN), 170.73) ?>
                        </div>
                    </div>
                </div>
            </div>
