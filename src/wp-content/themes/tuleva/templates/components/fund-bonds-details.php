                ...
                <div class="row">
                    ...
                    <div class="col-md-6 ps-md-6">
                        ...
                        <ul class="list-style-arrow text-secondary">
                            ...
                            <li>
                                <a href="<?php echo get_site_url(); ?>/wp-content/uploads/2026/02/Pohiteave-TUK00-kehtib-alates-27.02.2026.pdf" target="_blank"><?php _e('Key Investor Information', TEXT_DOMAIN) ?></a><?php _e(' (in Estonian)', TEXT_DOMAIN) ?>
                            </li>
                            <li>
