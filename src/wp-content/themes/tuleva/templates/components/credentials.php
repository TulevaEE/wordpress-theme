...
<section id="<?php the_sub_field('component_id'); ?>">
    ...
    <?php if ($security_text || ($members_count && $members_count_description)) { ?>
        <div class="container-fluid bg-blueish-gray py-5">
            <div class="container">
                <div class="row g-5">
                    <?php if ($security_text) { ?>
                        <div class="col-md-6 d-flex align-items-center justify-content-center text-navy">
                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="bi bi-shield-check me-4" viewBox="0 0 16 16">
                    ...
                    <?php if ($members_count && $members_count_description) { ?>
                        <div class="col-md-6 d-none d-md-flex align-items-center text-navy">
                            <span class="membercount text-nowrap me-4 display-5 lh-1">
