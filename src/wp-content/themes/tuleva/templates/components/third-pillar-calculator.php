    ...
    <div class="card-body p-3 text-center third-pillar-calculator">
        ...
        <div>
            <div class="p-3 calculator__comparison-row">
                <h6 class="calculator__comparison-fund"><?php _e('In a month you can place in III pillar', TEXT_DOMAIN); ?>:</h6>
                <div class="calculator__comparison-result">
                    <h5 class="mb-0" id="monthlyAmount">270 €</h5>
                </div>
            </div>
            <div class="p-3 calculator__comparison-row">
                <h6 class="calculator__comparison-fund"><?php _e('In a year you can place in III pillar', TEXT_DOMAIN); ?>:</h6>
                <div class="calculator__comparison-result">
        ...
        <div class="calculator__savings">
            <h6 class="calculator__savings-title"><?php _e('You win on income tax', TEXT_DOMAIN); ?></h6>
