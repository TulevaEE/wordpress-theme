                ...
                <div class="row">
                    ...
                    <div class="col-md-5 offset-md-1">
                        ...
                        <ul class="list-style-arrow mb-5">
                            ...
                            <li>
                                <a href="<?php echo get_site_url(); ?>/wp-content/uploads/2025/03/Fondide-vara-puhasvaartuse-maaramise-kord_17.04.2025.pdf" target="_blank"><?php _e('Procedure for determining net worth of fund (in Estonian)', TEXT_DOMAIN) ?> 17.04.2025</a>
                            </li>
                            <li>
                        ...
                        <ul class="list-style-arrow mb-5">
                            <li>
                                ...
                                <br>
                                <?php echo generate_report_link('https://tuleva.ee/wp-content/uploads/2025/04/Tuleva-Maailma-Aktsiate-Pensionifondi-investeeringute-aruanne-marts-2025-1.pdf'); ?>
                                <br>
                        ...
                        <div class="fund-info__item">
                            ...
                            <?php echo sprintf(__('%s tons / $1M turnover per year', TEXT_DOMAIN), 78.81) ?>
                        </div>
                    </div>
                </div>
            </div>
