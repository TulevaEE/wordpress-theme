                ...
                <div class="row">
                    ...
                    <div class="col-md-6 ps-md-6">
                        ...
                        <ul class="list-style-arrow mb-5 text-secondary">
                            <li>
                                <a href="<?php echo get_site_url(); ?>/wp-content/uploads/2026/02/TUK75-ja-TUK00-Prospekt-kehtib-alates-19.02.2026.pdf" target="_blank"><?php _e('Prospectus', TEXT_DOMAIN) ?></a><?php _e(' and ', TEXT_DOMAIN) ?><a href="<?php echo get_site_url(); ?>/wp-content/uploads/2025/05/Tuleva-Maailma-Aktsiate-Pensionifondi-tingimused-01.09.2025.pdf" target="_blank"><?php _e('Terms and conditions', TEXT_DOMAIN) ?></a><?php _e(' (in Estonian)', TEXT_DOMAIN) ?>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="<?php echo get_site_url(); ?>/wp-content/uploads/2026/02/Pohiteave-TUK75-kehtib-alates-19.02.2026.pdf" target="_blank"><?php _e('Key Investor Information', TEXT_DOMAIN) ?></a><?php _e(' (in Estonian)', TEXT_DOMAIN) ?>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="<?php echo get_nav_procedure_future_document_url(); ?>" target="_blank"><?php _e('Procedure for determining net worth of fund', TEXT_DOMAIN) ?> 02.03.2026</a><?php _e(' (in Estonian)', TEXT_DOMAIN) ?>
                            </li>
                            <li>
                        ...
                        <ul class="list-style-arrow mb-5 text-secondary">
                            <li>
                                <?php echo generate_report_link('https://tuleva.ee/wp-content/uploads/2026/02/Tuleva-Maailma-Aktsiate-Pensionifondi-investeeringute-aruanne-jaanuar-2026.pdf',__('Investment reports', TEXT_DOMAIN)); ?><?php _e(' (in Estonian)', TEXT_DOMAIN) ?>
                                <br>
                        ...
                        <p class="fund-info__item">
                            ...
                            <span><?php echo sprintf(__('%s tons / $1M turnover per year', TEXT_DOMAIN), 80.17) ?></span>
                        </p>
                    </div>
                </div>
            </div>
