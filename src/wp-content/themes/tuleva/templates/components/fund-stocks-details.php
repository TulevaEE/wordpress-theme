                    ...
                    <div class="col-md-5 offset-md-1">
                        ...
                        <ul class="list-style-arrow mb-5">
                            <li>
                                ...
                                <br>
                                <?php echo generate_report_link('https://tuleva.ee/wp-content/uploads/2023/12/TULAPF-investeeringute-aruanne-301123.pdf'); ?>
                                <br>
                        ...
                        <div class="fund-info__item">
                            ...
                            <?php echo sprintf(__('%s tons / $1M turnover per year', TEXT_DOMAIN), 98.52) ?>
                        </div>
                        <div class="fund-info__item">
