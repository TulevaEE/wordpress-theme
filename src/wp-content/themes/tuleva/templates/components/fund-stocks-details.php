                ...
                <div class="row">
                    ...
                    <div class="col-md-6 ps-md-6">
                        ...
                        <ul class="list-style-arrow mb-5 text-secondary">
                            <li>
                                <a href="<?php echo get_site_url(); ?>/wp-content/uploads/2026/03/TUK75-ja-TUK00-Prospekt-kehtib-alates-02.03.2026.pdf" target="_blank"><?php _e('Prospectus', TEXT_DOMAIN) ?></a><?php _e(' and ', TEXT_DOMAIN) ?><a href="<?php echo get_site_url(); ?>/wp-content/uploads/2026/08/Tuleva-Maailma-Aktsiate-Pensionifondi-tingimused-kehtib-alates-31.08.2026.pdf" target="_blank"><?php _e('Terms and conditions', TEXT_DOMAIN) ?></a><?php _e(' (in Estonian)', TEXT_DOMAIN) ?>
                                <br>
                                <a href="<?php echo get_site_url(); ?>/wp-content/uploads/2026/08/TUK75-ja-TUK00-Prospekt-kehtib-alates-01.01.2027.pdf" target="_blank"><?php _e('Prospectus', TEXT_DOMAIN) ?></a><?php _e(' and ', TEXT_DOMAIN) ?><a href="<?php echo get_site_url(); ?>/wp-content/uploads/2026/08/TUK75-tingimused-kehtivad-alates-01.01.2027-1.pdf" target="_blank"><?php _e('Terms and conditions', TEXT_DOMAIN) ?></a><?php printf(__(' (in Estonian, effective from %s)', TEXT_DOMAIN), '01.01.2027'); ?>
                            </li>
                            <li>
                        ...
                        <ul class="list-style-arrow mb-5 text-secondary">
                            <li>
                                <?php echo generate_report_link('https://tuleva.ee/wp-content/uploads/2026/09/Tuleva-Maailma-Aktsiate-Pensionifondi-investeeringute-aruanne-2026-08.pdf',__('Investment reports', TEXT_DOMAIN)); ?><?php _e(' (in Estonian)', TEXT_DOMAIN) ?>
                                <br>
