                    ...
                    <div class="col-md-5 offset-md-1">
                        ...
                        <ul class="list-style-arrow mb-5">
                            <li>
                                ...
                                <br>
                                <a href="<?php echo get_site_url(); ?>/wp-content/uploads/2022/09/TULAPF-investeeringute-aruanne-310822.pdf" target="_blank">08.22</a>
                                <br>
                        ...
                        <div class="fund-info__item">
                            ...
                            <?php echo sprintf(__('%s tons / $1M turnover per year', TEXT_DOMAIN), 146) ?>
                        </div>
                        <div class="fund-info__item">
