                ...
                <div class="row">
                    ...
                    <div class="col-md-5 offset-md-1">
                        ...
                        <ul class="list-style-arrow mb-5">
                            <li>
                                <a href="<?php echo get_site_url(); ?>/wp-content/uploads/2021/02/Prospekt.-TUK75-ja-TUK00.-kehtiv-19.02.2021.pdf" target="_blank"><?php _e('Prospectus', TEXT_DOMAIN) ?></a><?php _e(' and ', TEXT_DOMAIN) ?><a href="<?php echo get_site_url(); ?>/wp-content/uploads/2021/03/Tuleva-Maailma-Aktsiate-Pensionifondi-tingimused-05.03.2021.pdf" target="_blank"><?php _e('Terms and conditions', TEXT_DOMAIN) ?></a><?php _e(' (in Estonian)', TEXT_DOMAIN) ?>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="<?php echo get_site_url(); ?>/wp-content/uploads/2021/02/Pohiteave.-TUK75_19.02.2021.pdf" target="_blank"><?php _e('Key Investor Information (in Estonian)', TEXT_DOMAIN) ?></a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="https://docs.google.com/document/d/1zK5L2eu0noXtDWWR-cCwGX_SYPazkJLMqYvgq8fjpuU/edit" target="_blank">Teade tingimuste muudatustest alates 05.03.2021</a>
                            </li>
                        </ul>
                        ...
                        <ul class="list-style-arrow">
                            <li>
                                ...
                                <br>
                                <a href="<?php echo get_site_url(); ?>/wp-content/uploads/2021/03/TULAPF-investeeringute-aruanne-260221.docx.pdf" target="_blank">02.21</a>
                                <br>
