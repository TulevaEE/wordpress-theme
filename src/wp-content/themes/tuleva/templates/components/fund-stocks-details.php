            ...
            <div class="col-md-10 mx-auto">
                <div class="row">
                    ...
                    <div class="col-md-6 ps-md-6">
                        ...
                        <ul class="list-style-arrow mb-5 text-secondary">
                            <li>
                                <?php echo generate_report_link('https://tuleva.ee/wp-content/uploads/2025/10/Tuleva-Maailma-Aktsiate-Pensionifondi-investeeringute-aruanne-september-2025.pdf',__('Investment reports', TEXT_DOMAIN)); ?><?php _e(' (in Estonian)', TEXT_DOMAIN) ?>
                                <br>
                        ...
                        <p class="fund-info__item">
                            ...
                            <span><?php echo sprintf(__('%s tons / $1M turnover per year', TEXT_DOMAIN), 77.24) ?></span>
                        </p>
                    </div>
                </div>
            </div>
