    ...
    <div class="container">
        <div class="row py-6">
            <div class="col-lg-10 mx-auto text-center">
                <h1 class="mb-5"><?php _e('Tuleva World Bonds Pension Fund', TEXT_DOMAIN) ?></h1>
            </div>
        </div>
    </div>
</section>

<section id="bonds-proposal">
    <div class="container">
        <div class="row">
            <div class="col-lg-10 m-auto">
                <div class="proposal">
                    <div class="proposal__body">
                        <p class="mb-3"><?php _e('<strong>A conservative index fund that invests entirely in low-risk bonds.</strong> The expected return of this fund is significantly lower than that of the stock fund. It is impossible to achieve good returns with low risk.', TEXT_DOMAIN) ?></p>
