            ...
            <div class="col-lg-10 m-auto">
                <div class="proposal">
                    ...
                    <div class="proposal__cta">
                        <div class="d-grid"><?php _e('<a href="/en/online-bank-instructions/" class="btn btn-primary btn-lg btn-block" data-label="fund-details-choose-bonds">Select this fund</a>', TEXT_DOMAIN); ?></div>
                    </div>
                </div>
            </div>
        </div>
