...
$prospectus_url = tuleva_fund_disclosure_value('prospectus_file', get_site_url() . '/wp-content/uploads/2026/03/TUV100-Prospekt-kehtib-alates-02.03.2026.pdf');
$terms_url = tuleva_fund_disclosure_value('terms_file', get_site_url() . '/wp-content/uploads/2026/03/Tuleva-III-Samba-Pensionifondi-tingimused-kehtib-alates-02.03.2026.pdf');
$prospectus_upcoming_url = tuleva_fund_disclosure_value('prospectus_upcoming_file', get_site_url() . '/wp-content/uploads/2026/08/TUV100-Prospekt-kehtib-alates-18.09.2026.pdf');
$terms_upcoming_url = tuleva_fund_disclosure_value('terms_upcoming_file', get_site_url() . '/wp-content/uploads/2026/08/TUV100-tingimused-kehtivad-alates-18.09.2026.pdf');
...
$previous_reports_url = tuleva_fund_disclosure_value('previous_reports_url', 'https://www.pensionikeskus.ee/iii-sammas/vabatahtlikud-fondid/fid/81/');
$fund_co2_intensity = tuleva_fund_disclosure_value('fund_co2_intensity', '83.73');
?>
