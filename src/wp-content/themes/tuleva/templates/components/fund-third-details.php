            ...
            <div class="col-md-10 mx-auto">
                <div class="row">
                    ...
                    <div class="col-md-6 ps-md-6">
                        ...
                        <ul class="list-style-arrow text-secondary">
                            <li>
                                <?php echo generate_report_link('https://tuleva.ee/wp-content/uploads/2026/03/Tuleva-III-Samba-Pensionifondi-investeeringute-aruanne-veebruar-2026.pdf',__('Investment reports', TEXT_DOMAIN)); ?><?php _e(' (in Estonian)', TEXT_DOMAIN) ?>
                                <br>
