                ...
                <div class="row">
                    ...
                    <div class="col-md-5 offset-md-1">
                        ...
                        <ul class="list-style-arrow mb-5">
                            <li>
                                <a href="<?php echo get_site_url(); ?>/wp-content/uploads/2023/10/TUV100-Prospekt_05.10.2023.pdf" target="_blank"><?php _e('Prospectus', TEXT_DOMAIN) ?></a><?php _e(' and ', TEXT_DOMAIN) ?><a href="<?php echo get_site_url(); ?>/wp-content/uploads/2022/09/Tuleva-III-Samba-Pensionifondi-Tingimused_01.09.2022.pdf" target="_blank"><?php _e('Terms and conditions', TEXT_DOMAIN) ?></a><?php _e(' (in Estonian)', TEXT_DOMAIN) ?>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="<?php echo get_site_url(); ?>/wp-content/uploads/2023/10/20231005_Pohiteave_TUV100.pdf" target="_blank"><?php _e('Key Investor Information (in Estonian)', TEXT_DOMAIN) ?></a>
                            </li>
                            <li>
                        ...
                        <ul class="list-style-arrow mb-5">
                            <li>
                                ...
                                <br>
                                <?php echo generate_report_link('https://tuleva.ee/wp-content/uploads/2023/09/TUV100-investeeringute-aruanne-31.08.2023.pdf'); ?>
                                <br>
                        ...
                        <div class="fund-info__item">
                            ...
                            <?php echo sprintf(__('%s tons / $1M turnover per year', TEXT_DOMAIN), 100.11) ?>
                        </div>
                        <div class="fund-info__item">
