                ...
                <div class="card-deck">
                    <div class="card shadow-sm">
                        <div class="card-body text-center pt-5">
                            ...
                            <hr class="mb-4">
                            <p class="text-left"><?php _e('The equity fund with lowest costs in Estonia*: management fee <span class="text-highlight"><strong>0,34%</strong></span> and total expense ratio <span class="text-highlight"><strong>0,45%</strong></span>', TEXT_DOMAIN); ?></p>
