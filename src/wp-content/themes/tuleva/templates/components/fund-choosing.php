                ...
                <div class="card-deck">
                    <div class="card shadow-sm">
                        <div class="card-body text-center pt-5">
                            ...
                            <hr class="mb-4">
                            <p class="text-left"><?php  echo sprintf( __('Low cost: management fee %s0,31%%%s and total expense ratio %s0,39%%%s', TEXT_DOMAIN), '<span class="text-highlight"><strong>', '</strong></span>', '<span class="text-highlight"><strong>', '</strong></span>' ); ?></p>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body text-center pt-5">
                            ...
                            <hr class="mb-4">
                            <p class="text-left"><?php echo sprintf( __('Low cost: management fee %s0,31%%%s and total expenses %s0,43%%%s', TEXT_DOMAIN), '<span class="text-highlight"><strong>', '</strong></span>', '<span class="text-highlight"><strong>', '</strong></span>' ); ?></p>
                            <ul class="text-left list-style-checkmark mb-0">
