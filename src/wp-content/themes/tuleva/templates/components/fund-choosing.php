                ...
                <div class="card-deck">
                    <div class="card shadow-sm">
                        <div class="card-body text-center pt-5">
                            ...
                            <hr class="mb-4">
                            <p class="text-left"><?php  echo sprintf( __('Low cost: management fee %s0,34%%%s (from 01.04.2021 0,31%%) and total expense ratio %s0,42%%%s (from 01.04.2021 0,39%%)', TEXT_DOMAIN), '<span class="text-highlight"><strong>', '</strong></span>', '<span class="text-highlight"><strong>', '</strong></span>' ); ?></p>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body text-center pt-5">
                            ...
                            <hr class="mb-4">
                            <p class="text-left"><?php echo sprintf( __('Low cost: management fee %s0,34%%%s (from 01.04.2021 0,31%%) and total expenses %s0,46%%%s (from 01.04.2021 0,43%%)', TEXT_DOMAIN), '<span class="text-highlight"><strong>', '</strong></span>', '<span class="text-highlight"><strong>', '</strong></span>' ); ?></p>
                            <ul class="text-left list-style-checkmark mb-0">
