                ...
                <div class="card-deck">
                    <div class="card shadow-sm">
                        <div class="card-body text-center pt-5">
                            ...
                            <hr class="mb-4">
                            <p class="text-left"><?php _e('The equity fund with lowest costs in Estonia*: management fee <span class="text-highlight"><strong>0,34%</strong></span> and total expense ratio <span class="text-highlight"><strong>0,46%</strong></span>', TEXT_DOMAIN); ?></p>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body text-center pt-5">
                            ...
                            <hr class="mb-4">
                            <p class="text-left"><?php _e('Low cost: management fee <span class="text-highlight"><strong>0,34%</strong></span> and total expenses <span class="text-highlight"><strong>0,49%</strong></span>', TEXT_DOMAIN); ?></p>
                            <ul class="text-left list-style-checkmark mb-0">
