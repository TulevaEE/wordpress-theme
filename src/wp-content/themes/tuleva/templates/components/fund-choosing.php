                ...
                <div class="card-deck">
                    <div class="card shadow-sm">
                        <div class="card-body text-center pt-5">
                            ...
                            <h4>
                                <?php _e('<a href="/en/transfer-pension-tuleva/" target="_blank" class="text-navy">Tuleva World Stocks Pension Fund</a>', TEXT_DOMAIN); ?>
                            </h4>
                        ...
                        <div class="bg-white m-4">
                            ...
                            <?php _e('<a href="/en/transfer-pension-tuleva/" class="btn btn-primary btn-lg btn-block" id="fund-choose-stocks">Select this fund</a>', TEXT_DOMAIN); ?>
                        </div>
                    </div>
                    <div class="card shadow-sm">
                        <div class="card-body text-center pt-5">
                            ...
                            <h4>
                                <?php _e('<a href="/en/transfer-pension-tuleva/" target="_blank" class="text-navy">Tuleva World Bonds Pension Fund</a>', TEXT_DOMAIN); ?>
                            </h4>
                        ...
                        <div class="bg-white m-4">
                            ...
                            <?php _e('<a href="/en/transfer-pension-tuleva/" class="btn btn-primary btn-lg btn-block" id="fund-choose-bonds">Select this fund</a>', TEXT_DOMAIN); ?>
                        </div>
                    </div>
                </div>
            </div>
