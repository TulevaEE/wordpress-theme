    ...
    <div class="container">
                    ...
                    <div id="collapseOne" class="collapse my-5" aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="col-md-10 mx-auto">
                            ...
                            <p>Kui teed 20-aastaselt valiku, mis suurendab sinu pensionifondi tulu keskmiselt 1% võrra aastas,
                                ...
                                suurendad oma pensioni viiendiku võrra. 50-aastaselt tehtud valik jõuab parandada pensionit
                                kümnendiku võrra.</p>

                            <p>
                                <span class="text-highlight text-bold">Ära lükka valikut edasi.</span>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="collapseTwo" class="collapse my-5" aria-labelledby="headingTwo" data-parent="#accordion">
                        <div class="col-md-10 mx-auto">
                            ...
                            <p>Kui sul on pensionini rohkem kui kümme aastat,
                                ...
                                Sama soovitab oma inimestele näiteks Rootsi riik - tulemused on seni väga head. </p>

                            <p>Lepi sellega, et aktsiahindade kõikumised on järsemad kui võlakirjadel. Halbadel aegadel võid
                                näha oma pensionikontol miinust. Aga pikas plaanis saad järjekindlalt aktsiaid eelistades
                                suure tõenäosusega parema tulemuse. </p>
                        </div>
                    </div>
                </div>
                <hr />
                    ...
                    <div id="collapseThree" class="collapse my-5" aria-labelledby="headingThree" data-parent="#accordion">
                        <div class="col-md-10 mx-auto">
                            ...
                            <p>Nagu Warren Buffett, on enamik maailma juhtivaid majandusteadlasi veendunud, et pensioniks raha
                                ...
                                <span class="text-highlight text-bold">passiivselt juhitud pensionifond ehk indeksifond</span>. Sellises fondis võid kindel olla,
                                et sinu vara investeeritakse sama regulaarselt kui sa säästad. Aktiivselt juhitud fondis
                                võib fondijuht jätta su raha pikaks ajaks pangaarvele seisma või teha liiga uljaid investeerimisotsuseid.
                                Liigne kartlikkus ja julgus on sulle ühtemoodi kahjulikud.</p>
                            ...
                            />
                            <cite class="d-block small text-secondary mt-3 mb-5">Maailmaturu indeks: 50% MSCI ACWI (EUR) ja 50% Euro Government Bond Index. Eesti pensionifondide
                                tootlus mõõdetud EPI indeksiga, teenustasu arvestatud vastavalt rahandusministeeriumi statistikale.
                                Tuleva arvutused.</cite>

                            <p>Siis ei pea sa pead murdma, millal järgmine buum või kriis tuleb. Sinu keskmine ostuhind on alati
                                madalam kui kõige kõrgemalt tasemelt tehtud ostud – ja pikas plaanis on sul head eeldused
                                selleks, et sinu portfell kenasti kasvaks. </p>
                        </div>
                    </div>
                </div>
                <hr />
                <div class="qa__question-wrapper">
                    ...
                    <div id="collapseFour" class="collapse my-5" aria-labelledby="headingFour" data-parent="#accordion">
                        <div class="col-md-10 mx-auto">
                            ...
                            <p>Kõrged tasud on pikaajalise säästja suur vaenlane. Pole kokkusattumus, et Eesti pankade pensionifondid
                                on aastaid maailmas silma paistnud üheaegselt kõrgete tasude ja kehvade tulemuste poolest.
                                Tasude mõju on lihtne alahinnata.</p>

                            <p>Võtame näiteks Sanderi, kes on täna 25-aastane ja teenib Eesti keskmist palka. Oletame, et ta
                            ...
                            <p>Kui Sanderi pensionifondi jooksvad tasud (valitsemistasu + muud investeeringu kulud) on 0,5%
                                ...
                                eluaastaks 160 000 eurot. Kui aga jooksvad tasud on 1,6% aastas nagu Eesti kõrgeima tasuga
                                pensionifondidel, koguneb talle ainult 127 000 eurot.
                                <span class="text-highlight text-bold">Tasude tõttu kaotab Sander 33 000 eurot!</span>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="collapseFive" class="collapse my-5" aria-labelledby="headingFive" data-parent="#accordion">
                        <div class="col-md-10 mx-auto">
                            ...
                            <p>Kui sa veel ei kogu madala tasu ja agressiivse strateegiaga indeksifondis,
                                <span class="text-highlight text-bold">vaheta fondi</span>. </p>

                            <p>Edasi on vaja püsivust. Kõige halvemad otsused väärtpaberiturgudel tehakse hetke ajel. Sina püsi
                                kindlalt madalate kuludega fondis läbi turgude tõusude ja languste. Hoidu kiusatusest teha
                                lühiajaliste kõikumiste põhjal järske liigutusi. Põikle kõrvale sind peibutavate müügimeeste
                                ja manitsevate pangatellerite eest.</p>

                            <p>Korra viie aasta jooksul võiksid oma pensionifondi strateegia ja tasud üle vaadata, aga suuremaid
                                muutusi kaalu alles siis, kui pensionini on jäänud ainult kümme aastat.</p>
                        </div>
                    </div>
                </div>
                <hr />
                ...
                <div class="text-center">
                    <div class="text-left">
                        ...
                        <ul class="list-style-checkmark">
                            ...
                            <li>
                                <span class="text-highlight text-bold">Investeerime passiivselt</span>. See tähendab, et jagame raha reeglipäraselt maailma
                                suurimate ettevõtete aktsiate ja valitsuste võlakirjade vahel.</li>
                            <li>
                            ...
                            <li>Keskendume <span class="text-highlight text-bold">pikaajalisele tootlusele</span>, sest katsed lühiajalisi kõikumisi vähendada oleks pikaajalisele
                                investorile tarbetu kulu.</li>
                            <li>Hoiame
                                <span class="text-highlight text-bold">kulud nii madalal kui võimalik</span> ja ei kuluta investorite raha ekstravagantsetele
                                reklaamikampaaniatele, müügimeeste armeedele ega muudele asjadele, mis pensionikogujatele
                                pikas plaanis väärtust ei loo.</li>
                        </ul>
                    </div>
                    <div class="pt-4">
        ...
        <div class="row my-5">
            <div class="col-md-10 col-lg-8 mx-auto">
                ...
                <p>Tuleva ei ole pank, vaid
                    ...
                    <span
                        class="text-highlight text-bold">inimeste, mitte pankade</span> ja kindlustusseltside kasust.</p>
        ...
        <div class="row text-center mt-4">
            <div class="col-md-10 col-lg-8 mx-auto">
                ...
                <p>
                    Helista <a href="tel:+3726445100">644 5100</a> või kirjuta <a href="mailto:tuleva@tuleva.ee">tuleva@tuleva.ee</a>
                </p>
            </div>
        </div>
    </div>
