            ...
            <div class="offset-md-1 col-md-10">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <link href="<?php echo get_template_directory_uri(); ?>/inline-widgets/login/css/main.14fe4546.css" rel="stylesheet">
                        <script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/inline-widgets/login/js/main.82f7baa4.js"></script>
