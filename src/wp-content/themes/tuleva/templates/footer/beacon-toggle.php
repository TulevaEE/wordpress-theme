        ...
        <form action="https://tuleva.us13.list-manage.com/subscribe/post?u=594cafb01e6f3b0087743e6f5&amp;id=b30d5d60e3" method="post"
            ...
            <div id="mc_embed_signup_scroll">
                ...
                <div class="mc-field-group">
                    ...
                    <input type="text" value="" name="LNAME" class="required form-control" id="mce-LNAME" required>
                </div>
                <div class="mc-field-group">
                ...
                <div class="clear">
                    <input type="submit" value="Soovin Tuleva uudiskirja" name="subscribe" id="mc-embedded-subscribe" class="button btn btn-primary btn-block mb-0">
                </div>
            </div>
        </form>
    </div>
