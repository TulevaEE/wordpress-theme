        ...
        <div class="container">
            <div class="row py-5">
                <div class="col-lg-8 mx-auto text-center">
                    <h2 class="my-5">Mille poolest Tuleva pankadest erineb?</h2>
                    <p class="lead text-navy mb-4">Tuleva pensionifondid on pankade omadega üsna sarnased.</p>
                    <h4 class="text-navy mb-4">Välja arvatud peamine.
                        <span class="text-highlight text-bold">Hoiame tasud hästi madalal</span>.</h4>
                    <p class="lead text-navy">Kulutame ainult nendele asjadele, mis aitavad meie pensionivaral kasvada.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-lg-8 mx-auto">
                ...
                <h3 class="text-center mb-5">Meie ühistes fondides ei kulu sinu raha</h3>
                ...
                <p>Tänu sellele on meie fondid juba praegu mitu korda soodsama tasuga kui pankade fondid.
                ...
                <p>Me usume, et pangad usuvad tegelikult ka. Lihtsalt nemad peavad õigustama kõrgeid tasusid, et omanikele kasumit teenida. </p>
