        ...
        <div class="container">
            <div class="row py-5">
                <div class="col-lg-8 mx-auto text-center">
                    <p class="lead text-navy">Tuleva pensionifondid on pankade omadega üsna sarnased.</br>
                    Välja arvatud peamine.</p>
                    <h2><span class="text-highlight">Hoiame tasud hästi madalal</span></h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-10 col-lg-8 mx-auto">
                <div class="text-center">
                    <h3 class="mb-4">5 soovitust pensionifondi valikuks</h3>
                    <a class="btn btn-primary btn-lg d-block d-md-inline-block mb-4 mb-md-0 mr-md-4" href="https://tuleva.ee/vali-pensionifond-targalt/">Olen noorem kui 55</a>
                    <a class="btn btn-primary btn-lg d-block d-md-inline-block" href="https://tuleva.ee/valmistu-pensioniks-targalt/">Olen vanem kui 55</a>
                </div>
            </div>
        </div>
