    ...
    <nav class="navbar navbar-expand-md">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <div class="d-flex flex-column flex-md-row align-items-md-center ml-auto">
                <?php language_picker(); ?>
                <?php _e('<a href="/en/transfer-pension-tuleva/" class="btn btn-primary btn-block d-block d-md-none d-lg-block ml-md-2 mt-4 mt-md-0">Switch II pillar to Tuleva</a>', TEXT_DOMAIN); ?>
            </div>
        </div>
    </nav>
</header>
