    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 footer__text">
                ...
                ?>
                <p><?php printf(__('Before you decide which pension fund you’d like to move your second-pillar units and future contributions to, be sure to read through the important information. The terms of our pension funds can be found %1$shere%2$s. Before you decide which pension fund you’d like to move your second-pillar units and future contributions to, be sure to read through the important information. The terms of our pension funds can be found <a href="http://www.pensionikeskus.ee/en/ii-pillar/funds/fund-fees-comparison/">here.</a> For comparison, information on all Estonian pension funds is available at the Pension Centre. Please note that Tuleva cooperative, Tuleva management company and Tuleva employees do not dispense investment advice, and cannot do so, because we have not sought an activity licence in the field of investment advice. However, we do our best to provide you with truthful, comprehensible information that you can use to make up your own mind. If you have any questions, don’t hesitate to contact us, or consult impartial experts via the Pension Centre’s <a href="http://www.pensionikeskus.ee/en/">information line</a> or the Financial Supervision Authority’s <a href="http://minuraha.ee/kontaktandmed/">money matters page</a>.', TEXT_DOMAIN), '<a href="'.$page_url.'">', '</a>'); ?></p>
