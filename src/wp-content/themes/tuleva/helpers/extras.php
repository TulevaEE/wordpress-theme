...
function get_esg_document_url() {
    ...
    if (ICL_LANGUAGE_CODE == 'et') {
        $esg_document_path = '/wp-content/uploads/2025/07/Jatkusuutlikkusriskide-arvesse-votmise-pohimotted-30.06.2025.pdf';
    }
...
function get_esg_factors_document_url() {
    ...
    if (ICL_LANGUAGE_CODE == 'et') {
        $esg_factors_document_path = '/wp-content/uploads/2025/07/Investeerimisotsuste-poolt-kestlikkusteguritele-avaldatava-negatiivse-moju-mittearvestamine-30.06.2025.pdf';
    }
