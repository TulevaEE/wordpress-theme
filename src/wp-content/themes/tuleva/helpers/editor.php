...
function tiny_mce_before_init_insert_formats($init_array) {
    $style_formats = [
        ...
        */
        ...
        [
            'title' => 'Checkmark style list',
            'selector' => 'ul',
            'classes' => 'list-style-checkmark'
        ],
        [
            'title' => 'Plus style list',
            'selector' => 'ul',
            'classes' => 'list-style-plussign'
        ],
        [
            'title' => 'Text muted',
            'inline' => 'span',
        ...
        [
            'title' => 'Text large (block)',
            'selector' => 'ul, ol, p, div, blockquote',
            'classes' => 'text-lg'
        ],
        [
            'title' => 'Text large (inline)',
            'inline' => 'span',
            'classes' => 'text-lg'
        ],
    ];
